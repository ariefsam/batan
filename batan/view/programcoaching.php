<!-- bagian tengah -->
	...
	<!-- area isi-->
		...
		<form action="" method="post" name="frm" style="margin-left: 20px; margin-top: 10px; margin-bottom:5px;">
									...
									<option value="ProgramTahunan" >Program Tahunan</option><option value="ProgramPelatihan">Program Pelatihan</option><option value="ProgramCoaching" selected="selected">Program Coaching</option></select> &nbsp &nbsp &nbsp
		      ...
		      <div><p class="area_judul" style="padding-top: 1px"><span>Program Coaching</span></p> </div><br><br>
			  <table style=" margin-left: 10px; margin-right: 8px; margin-bottom: 10px; border:1px dashed #ccc;">
			  <th width="20px;">No</th><th width="200px;">Nama kegiatan</th><th width="80px;">Tanggal</th><th width="120px;">Pukul</th><th width="140">Tempat</th><th width="80">Penyelenggara</th>
